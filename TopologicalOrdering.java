...
public class TopologicalOrdering {
     ...
     *
     * @description Takes a Graph and returns a stack containing list of vertices in reverese topological order
     *              if it is a DAG else returns null
     *
     */
    public static Stack<Vertex> TopologicalOrdering2(Graph G) {
